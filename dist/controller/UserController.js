...
var UserController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        return [2 /*return*/, { message: "User was created" }];
                }
            });
        });
    };
    UserController.prototype.remove = function (request, response, next) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userRepository.findOneBy({ id: Number(request.params.id) })];
                    case 1:
                    ...
                    case 2:
                        ...
                        // }
                        _a.sent();
                        return [2 /*return*/, { message: "user has been removed" }];
                }
            });
        });
    };
